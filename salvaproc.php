...
define('FPDF_FONTPATH','fpdf16/font/');
    ...
    $sqlcon = "SELECT nome FROM convenios WHERE id = '$convenio1';";
	...
	$pdf->Ln(10);
	$pdf->SetFont('Arial','',8);
	$pdf->Cell(0,10,utf8_decode('Procedimentos já autorizados pelo departamento responsável do convênio acima citado.'),0,0,'C');
