...
$sqlp = "SELECT id, nome FROM profissionais WHERE tipo = 'CRM'";
...
<form method="POST" action="salvafichamedica.php" name="salvafichamedica">
<div id="tabs">
	<ul>
		<li><a href="#tabs-1">Ficha Médica</a></li>
	</ul>
	<div id="tabs-1">
		<table>
			<tr>
